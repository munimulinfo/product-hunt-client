...
const Login = () => {
    const { signIn, loading, setLoading, resetPassword, logOut } = useContext(AuthContext);
                ...
                <form className="border border-[#F7A582] rounded-lg p-6 login-shadow" onSubmit={handleSubmit(onSubmit)} action="">
                    ...
                    <div className="form-control relative w-full">
                        <label className="label flex justify-between">
                            ...
                            <button onClick={() => handelReset()} className="label-text font-bold font-serif text-[#F7A582]">Forgot password?</button>
                        </label>
                        ...
                        <label className="label">
                            {error && (
                                <p className="text-red-500 inline-block">{error}</p>
                            )}
                        </label>
                    ...
                    <h1 className="text-center mt-3">Please register at first. Go to <span className="text-green-800 font-semibold underline"><Link to={'/register'}>SIGN UP</Link></span></h1>
                </form>
            </div>
        </div>
    );
