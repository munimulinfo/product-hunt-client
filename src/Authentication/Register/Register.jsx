...
const Register = () => {
    const { createUser, updateUserProfile, loading, setLoading, logOut } = useContext(AuthContext);
        ...
        <div className="flex flex-col min-h-screen justify-center items-center">
            <div className="w-full h-full md:px-20 px-5 flex justify-center items-center ">
                <form className="border border-[#F7A582] rounded-lg p-6 login-shadow" onSubmit={handleSubmit(onSubmit)} action="">
                    <h1 className="text-2xl text-center mb-2 font-serif text-green-900 uppercase font-bold ">Sign up to InstaGram</h1>
